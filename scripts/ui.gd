...
func _ready() -> void:
	...
	add_parameter(ParameterEnum.new("albedo_type", 0, ["colour_blend", "heightmap", "normal", "grey", "black"]), false);
	...
	terrain_generation_method_option_button = add_parameter(ParameterEnum.new("terrain_generation_method", -1, terrain_generation_method_names), false);
